...
def manual_auth():
    ...
    callback_url = "https://127.0.0.1"  # Your registered URL without port
    ...
    try:
        ...
        try:
            ...
            if accounts_response.status_code == 200:
                ...
                print(f"✅ Token saved successfully, but account test returned status {accounts_response.status_code}")
                print("This might be normal if you don't have trading accounts linked or need additional permissions.")
...
def main():
    ...
    if check_existing_token():
        print("Using existing token. If API calls fail, delete schwab_tokens.json and re-run this script.")
        return
